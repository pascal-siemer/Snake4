...
//Prueft die Einstellungen des Browsers, ob Cookies aktiv sind. Wenn nein, koennen keine Cookies gespeichert werden. Es wird ein Alert ausgegeben.
function checkCookiesEnabled() {
    //Check ueber Browser-Eisntellungen
    if(!navigator.cookieEnabled) {
        window.alert("Cookies sind deaktiviert! Highscores werden nicht gespeichert.");
        return false;
    }
    //Praxis-Check: Cookie Speichern und wieder loeschen
    document.cookie = 'cookieCheck=true; expires=true' + cookieExpireDate.toGMTString() + '; path=/';
    if(document.cookie.indexOf('cookieCheck') != -1)  {
        document.cookie = 'cookieCheck=true; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=/';
        return true
    } else {
        window.alert("Cookies sind deaktiviert! Highscores werden nicht gespeichert.");
        return false;
...
//---Definitionen der Objekte Snake fuer die Schlange und Food---------------------------------------------------------------------------------------------------------------------------------------------------------------
